...
| **Done** | Fitur Backup/Restore JSON (export `janka-backup-YYYY-MM-DD.json`, validasi skema v1, preview & dialog restore) | agy | Tombol Backup/Restore di DashboardSummary, penanganan edge-case quota storage, batal tanpa mutasi, test_logic 100% lulus. |
...
2. **Offline Web Storage Backup:** Fitur Backup & Restore JSON dengan validasi versi 1 & penanganan quota storage telah selesai diimplementasikan.
